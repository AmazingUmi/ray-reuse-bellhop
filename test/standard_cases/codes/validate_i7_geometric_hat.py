...
def validate(
    ...
    if companion_hashes["origin"] != companion_hashes["f2cpp"]:
        raise ValueError("Origin and F2CPP companion inputs differ")
    ...
    return {
        "schema": "bellhop.f2cpp.i7_geometric_hat_validation",
        "schema_version": 1,
        "status": "passed",
        "matrix": {
