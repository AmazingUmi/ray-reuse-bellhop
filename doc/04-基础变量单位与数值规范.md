...
项目负责人已于 2026-07-27 确认 D-01～D-06，基础实现按本节确定值执行。
D-07～D-12 在对应 oracle 和实现阶段继续确认。

### 1.1 已确认的开工决策：原 Bellhop 与本项目设置对照
...
| C-linear SSP | 已冻结节点/层索引语义；后续补逐频虚声速和原始衰减映射 |
