...
using broadband::CartesianCervenyDiagnostic;
using broadband::CartesianCervenyDiagnosticRequest;
using broadband::CartesianCervenyInfluence;
using broadband::CartesianCervenySettings;
using broadband::CartesianCervenyStatistics;
using broadband::cervenyHermiteTaper;
using broadband::CervenyImageKind;
...
using broadband::updateCervenyKmah;
...
void checkImage(Context& context,
                const broadband::CartesianCervenyImageDiagnostic& image,
...
int main() {
  ...
  std::cout
      << "All Bellhop Broadband Cartesian Cerveny influence tests passed\n";
  return 0;
}
