#include "broadband/model/quadrilateral_ssp.hpp"
...
#include "broadband/model/quadrilateral_frequency_ssp.hpp"
...
using broadband::QuadrilateralFrequencySsp;
using broadband::QuadrilateralSsp;
...
int main() {
  ...
  std::cout << "All Bellhop Broadband quadrilateral SSP tests passed\n";
  return 0;
}
