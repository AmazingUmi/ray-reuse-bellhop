...
#include "broadband/numerics/cubic_spline_coefficients.hpp"
#include "support/test_harness.hpp"

namespace {

using broadband::AttenuationUnit;
using broadband::computeCubicSplineCoefficients;
...
int main() {
  ...
  std::cout << "All Bellhop Broadband cubic-spline SSP tests passed\n";
  return 0;
}
