...
using broadband::RayCenteredCervenyDiagnostic;
using broadband::RayCenteredCervenyDiagnosticRequest;
using broadband::RayCenteredCervenyInfluence;
...
RayPath makeSlantedPath(std::size_t pointCount, double dynamicP) {
  const std::vector<broadband::Vec2> positions{
