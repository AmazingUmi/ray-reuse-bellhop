#include "broadband/acoustics/boundary_acoustics.hpp"
...
using broadband::BoundaryAcousticsResult;
using broadband::BoundaryGeometry;
using broadband::BoundaryModel;
using broadband::BoundaryOrientation;
using broadband::classifyBoundaryCoefficient;
using broadband::convertAttenuation;
using broadband::evaluateAcousticHalfSpaceAcoustics;
using broadband::evaluateBoundaryAcoustics;
using broadband::evaluateGrainSizeHalfSpaceAcoustics;
using broadband::evaluateTabulatedReflectionAcoustics;
using broadband::GrainSizeMaterial;
using broadband::TabulatedReflectionPoint;
using broadband::TabulatedReflectionTable;
...
void testFluidHalfSpaceOracles(Context& context) {
  for (const auto& fixture : broadband::test::kHalfSpaceCoefficientFixtures) {
...
void testCoefficientApplicationSemantics(Context& context) {
  for (const auto& fixture :
       broadband::test::kRawCoefficientApplicationFixtures) {
...
int main() {
  ...
  std::cout << "All Bellhop Broadband boundary acoustics tests passed\n";
  return 0;
}
