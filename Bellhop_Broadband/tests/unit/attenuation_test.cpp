...
using broadband::AttenuationConversion;
using broadband::attenuationNpPerMeter;
using broadband::AttenuationUnit;
using broadband::BiologicalAttenuationLayer;
using broadband::BiologicalAttenuationLayers;
using broadband::biologicalAttenuationNpPerMeter;
using broadband::convertAttenuation;
using broadband::francoisGarrisonAttenuationNpPerMeter;
using broadband::FrancoisGarrisonParameters;
using broadband::imaginarySoundSpeedFromAttenuation;
using broadband::RawAttenuation;
using broadband::thorpAttenuationNpPerMeter;
...
int main() {
  ...
  std::cout << "All Bellhop Broadband attenuation tests passed\n";
  return 0;
}
