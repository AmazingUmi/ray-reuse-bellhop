...
> 历史状态说明：本报告采集时 H4-5 仍记为等待第二 Fortran 编译器。项目于
> 2026-08-07 后续决定将 GNU Fortran/gfortran 定为唯一支持的 Fortran
> oracle 工具链，H4-5 随后取消；下文保留采集时原始结论作为证据。
...
Fortran 编译器后，再按
[`PLAN_CROSS_COMPILER_H4.md`](../archive/plans/PLAN_CROSS_COMPILER_H4.md) 的 H4-5 执行
