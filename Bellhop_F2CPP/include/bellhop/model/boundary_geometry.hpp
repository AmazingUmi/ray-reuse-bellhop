...
// Value-owned range/depth boundary geometry. I3-01 intentionally starts with
// a zero-allocation flat specialization; piecewise-linear and curved storage
// are added behind this interface by the following I3 vertical slices.
class BoundaryGeometry {
 public:
  [[nodiscard]] static BoundaryGeometry flat(
