...
| Stage | Status | Tasks |
|---|---|---|
| I8-01 Arrival data model & accumulation | IN_PROGRESS | T1–T3 ACCEPTED; T4–T5 TODO |
| I8-02 Arrival writers | TODO | T1–T3 |
| I8-03 Eigenray mode | TODO | T1–T5 |
| I8-04 Validation & documentation | TODO | T1–T5 |

I8-01-T1/T2/T3 have established the accepted record types, checked capacity
...
pressure, intensity, and arrival sinks; source orchestration remains next.
