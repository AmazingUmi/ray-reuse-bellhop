...
| 目的 | 文档 |
|---|---|
| R/A/a/E 与多频运行 | [`guides/GUIDE_USAGE.md`](./guides/GUIDE_USAGE.md) |
| 性能基准 | [`guides/GUIDE_BENCHMARKING.md`](./guides/GUIDE_BENCHMARKING.md) |
...
| 支持、差异与延期边界 | [`reference/REFERENCE_FEATURE_SUPPORT_MATRIX.md`](./reference/REFERENCE_FEATURE_SUPPORT_MATRIX.md) |
| 当前状态 | [`status/STATUS_PROGRESS.md`](./status/STATUS_PROGRESS.md) |
...
项目级下一步见
[`doc/plans/PLAN_CURRENT_WORK.md`](../../doc/plans/PLAN_CURRENT_WORK.md)。Influence 频率复用
