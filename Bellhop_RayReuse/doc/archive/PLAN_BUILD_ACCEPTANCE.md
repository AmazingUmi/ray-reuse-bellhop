...
[`STATUS_PROGRESS.md`](../status/STATUS_PROGRESS.md) 和
[`PLAN_FEATURE_SYNC.md`](./plans/PLAN_FEATURE_SYNC.md)。本文后续 A～H
...
[`archive/RECORD_DERIVATION.md`](./RECORD_DERIVATION.md) 和对应基准记录中。
...
[`REPORT_F2_64_FREQUENCY_MATRIX_FDAAF56_2026-07-31.md`](./benchmarks/REPORT_F2_64_FREQUENCY_MATRIX_FDAAF56_2026-07-31.md)。
...
[`GUIDE_RELEASE.md`](../guides/GUIDE_RELEASE.md)，HDF5 决策见
[`DECISION_HDF5_SCHEMA.md`](../decisions/DECISION_HDF5_SCHEMA.md)。
...
见 [`GUIDE_BENCHMARKING.md`](../guides/GUIDE_BENCHMARKING.md)。
...
最终本机矩阵证据见
[`REPORT_MODEL_MATRIX_06E390F_2026-08-01.md`](../reports/REPORT_MODEL_MATRIX_06E390F_2026-08-01.md)。远端
...
3. [x] 建立 origin/F2CPP/RayReuse 中间几何状态门，覆盖 direct、
   vacuum/rigid、Munk；
4. [x] 按 [`PLAN_CROSS_COMPILER_H4.md`](./plans/PLAN_CROSS_COMPILER_H4.md) 完成本地
...
H4 C++ 关闭证据见
[`REPORT_CROSS_COMPILER_H4_2026-08-07.md`](../reports/REPORT_CROSS_COMPILER_H4_2026-08-07.md)。两套
