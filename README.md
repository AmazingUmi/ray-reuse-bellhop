...
| `Bellhop_Broadband/` | Bellhop Broadband 产品实现；已完成 F2CPP production Feature Parity 的独立多频实现，RayReuse 是其中的轨迹复用算法族 |

当前正式状态：

```text
Bellhop_F2CPP → Bellhop_Broadband
...
产品名为 **Bellhop Broadband**（可执行程序 `bellhop_broadband`），RayReuse 是其
中的轨迹复用技术族，
...
- [Feature Parity Final Report](Bellhop_Broadband/doc/reports/REPORT_FEATURE_PARITY_FINAL.md)
- [RayReuse Feature Support Matrix](Bellhop_Broadband/doc/reference/REFERENCE_FEATURE_SUPPORT_MATRIX.md)
- [RayReuse Usage Guide](Bellhop_Broadband/doc/guides/GUIDE_USAGE.md)
...
[IGR-3 Scope & Architecture Decision](Bellhop_Broadband/doc/worklists/IGR-3_SCOPE_AND_ARCHITECTURE_DECISION.md)
与 [Feature Support Matrix](Bellhop_Broadband/doc/reference/REFERENCE_FEATURE_SUPPORT_MATRIX.md)。
...
Bellhop_Broadband/    C++20 多频轨迹复用 production implementation
test/PlotRead/        SHD 读取、绘图和自包含 fixtures
test/standard_cases/  Origin、F2CPP、Broadband 共用算例与 validators
...
- [Bellhop Broadband 构建、运行与质量门](Bellhop_Broadband/README.md)
- [项目文档索引](doc/README.md)
- [RayReuse 文档索引](Bellhop_Broadband/doc/README.md)
- [Demo](demo/README.md)
